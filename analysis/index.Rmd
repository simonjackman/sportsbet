...
- Sportsbet is currently offering odds in all 151 House of Representative seats; we use the most recently available odds. 
...
The second column of seat counts removes "long-shots"; the third column counts seats where the indicated party has the highest
IPOW.
...
Seats with odds changing in the last 24 hours: `r if(nrow(tab)==0){"none"}`
